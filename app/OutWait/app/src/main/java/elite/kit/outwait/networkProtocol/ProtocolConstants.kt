...
/**
 * Constants, representing the keys used in the JSON Objects that are transmitted and received
 * according to the specified (JSON) protocol
 * @see design documentation (section 9 "Kommunikation App-Server for semantic meaning)
 *
 */
