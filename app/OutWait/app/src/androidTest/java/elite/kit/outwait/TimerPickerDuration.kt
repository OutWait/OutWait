...
class TimerPickerDuration {
    ...
    fun timerPickerDuration() {
        ...
        extendedEditText2.perform(replaceText("test2"), closeSoftKeyboard())
        ...
        val appCompatImageView = onView(
            allOf(
                withId(R.id.ivSaveTransaction),
                childAtPosition(
                    allOf(
                        withId(R.id.tvSpoSlotContainerHeader),
                        childAtPosition(
