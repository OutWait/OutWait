...
class SwitchToModeTwoTest {
    ...
    fun initTest() {
        ...
        // Ensure mode one
        if(instituteRepo.getObservablePreferences().getValue()!!.mode != Mode.ONE) {
    ...
    fun switchToModeTwo(){
        ...
        // Check mode
        assertEquals(Mode.ONE, instituteRepo.getObservablePreferences().getValue()!!.mode)
        ...
        onView(withId(R.id.tpAppointmentTime)).perform(scrollTo(), AppointmentSetter.setAppointment(slot1Time.hourOfDay().get(), slot1Time.minuteOfHour().get()))
        ...
        DigitSelector.pressClear(R.id.addSlotDuration)
        DigitSelector.pressDigit(DigitSelector.digitOne, R.id.addSlotDuration)
        onView(withId(R.id.tpAppointmentTime)).perform(scrollTo(), AppointmentSetter.setAppointment(slot2Time.hourOfDay().get(), slot2Time.minuteOfHour().get()))
        onView(withText(StringResource.getResourceString(R.string.confirm))).perform(click())
        ...
        DigitSelector.pressClear(R.id.addSlotDuration)
        DigitSelector.pressDigit(DigitSelector.digitOne, R.id.addSlotDuration)
        onView(withId(R.id.tpAppointmentTime)).perform(scrollTo(), AppointmentSetter.setAppointment(slot3Time.hourOfDay().get(), slot3Time.minuteOfHour().get()))
        onView(withText(StringResource.getResourceString(R.string.confirm))).perform(click())
        ...
        // Check queue
        assertEquals(2, instituteRepo.getObservableTimeSlotList().getValue()!!.size)
        assertEquals(auxIdentifier4, (instituteRepo.getObservableTimeSlotList().getValue()!![0] as ClientTimeSlot).auxiliaryIdentifier)
        assertEquals(auxIdentifier3, (instituteRepo.getObservableTimeSlotList().getValue()!![1] as ClientTimeSlot).auxiliaryIdentifier)
    }
