...
class UpdateMediatorTest {
    ...
    /**
     * First tests subscribeReceiver() method.
     *  Checks if setSlotData is called with correct parameters
     * Then tests unsubscribeReceiver() method.
     *  Checks if setSlotData does NOT call setSlotData on slotInformationReceiverMock
     */
    ...
    fun testSubscribeAndUnsubscribeReceiver() {
        ...
        every { testObj.setSlotData(capture(slotCodeCapturer), capture(slotApproxCapturer), capture(slotManagementInformationCapturer)) } just runs
        testObj.subscribeReceiver(slotInformationReceiverMock, slotCodeMock, slotApproxMock, slotManagementInformationMock)
    ...
    fun testSetSlotApprox() {
        ...
        verify {
            slotInformationReceiverMock.setSlotData(Date(321000),
    ...
    fun testEndSlot() {
        ...
        verify {
            slotInformationReceiverMock.end()
        }
    }
    ...
    fun testDeleteSlot() {
        ...
        verify {
            slotInformationReceiverMock.delete()
        }
    }
